...
class OldSchool:
    ...
    def to_csv(self,data):
        fields = ['name', 'link', 'Released', 'Members', 'Combat level', 'Size','XP bonus','Attribute',
    ...
    def get_bosses_links(self):
        ...
        if content:
            ...
            other_bosses = soup.find_all("ul")
            phase_two = other_bosses[4]            
            boss_tag= other_bosses[4]
            lis= boss_tag.find_all("li")
            for li in lis:
                [self.bosses_list.append("https://oldschool.runescape.wiki" + li.a['href'])]
